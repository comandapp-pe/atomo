...
class Faraday::RequestOptions < Anonymous_Faraday_Options_37
  def []=(key, value); end
...
class Faraday::SSLOptions < Anonymous_Faraday_Options_38
  def disable?; end
  def verify?; end
end
...
class Faraday::ProxyOptions < Anonymous_Faraday_Options_39
...
class Faraday::ConnectionOptions < Anonymous_Faraday_Options_40
  def builder_class; end
...
class Faraday::Env < Anonymous_Faraday_Options_41
  def [](key); end
  def []=(key, value); end
  def body; end
  def body=(value); end
...
class Faraday::Request < Anonymous_Struct_42
  def [](key); end
  def []=(key, value); end
  def headers=(hash); end
